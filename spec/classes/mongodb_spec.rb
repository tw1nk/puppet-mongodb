...
describe 'mongodb' do
  ...
  describe 'Test standard installation with monitoring and firewalling' do
    ...
    it 'should monitor the process' do
      content = catalogue.resource('monitor::process', 'mongodb_process').send(:parameters)[:enable]
      content.should == true
    end
    it 'should place a firewall rule' do
      content = catalogue.resource('firewall', 'mongodb_tcp_42').send(:parameters)[:enable]
      content.should == true
    end
  end
  ...
  describe 'Test customizations - source' do
    let(:params) { {:source => "puppet://modules/mongodb/spec" , :source_dir => "puppet://modules/mongodb/dir/spec" , :source_dir_purge => true } }

    it 'should request a valid source ' do
      content = catalogue.resource('file', 'mongodb.conf').send(:parameters)[:source]
      content.should == "puppet://modules/mongodb/spec"
    end
    it 'should request a valid source dir' do
      content = catalogue.resource('file', 'mongodb.dir').send(:parameters)[:source]
      content.should == "puppet://modules/mongodb/dir/spec"
    end
    it 'should purge source dir if source_dir_purge is true' do
      content = catalogue.resource('file', 'mongodb.dir').send(:parameters)[:purge]
      content.should == true
    end
  end
  ...
  describe 'Test service autorestart', :broken => true do
    it 'should automatically restart the service, by default' do
      ...
      content.should == 'Service[mongodb]{:name=>"mongodb"}'
    end
  end
  ...
  describe 'Test Puppi Integration' do
    ...
    it 'should generate a puppi::ze define' do
      content = catalogue.resource('puppi::ze', 'mongodb').send(:parameters)[:helper]
  ...
  describe 'Test Monitoring Tools Integration' do
    ...
    it 'should generate monitor defines' do
      content = catalogue.resource('monitor::process', 'mongodb_process').send(:parameters)[:tool]
  ...
  describe 'Test Firewall Tools Integration' do
    ...
    it 'should generate correct firewall define' do
      content = catalogue.resource('firewall', 'mongodb_tcp_42').send(:parameters)[:tool]
  ...
  describe 'Test OldGen Module Set Integration' do
    ...
    it 'should generate puppi resources ' do 
      content = catalogue.resource('puppi::ze', 'mongodb').send(:parameters)[:ensure]
