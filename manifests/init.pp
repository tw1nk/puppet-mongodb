...
# - Set variables (at top scope level on in a ENC) and "include mongodb"
# - Call mongodb as a parametrized class
#
...
class mongodb (
  ...
  $protocol            = params_lookup( 'protocol' )
	...
	case $operatingsystem {
		redhat: { require yum::repo::10gen }
		centos: { require yum::repo::10gen }
		default: { }
	}
  ...
  if $mongodb::source_dir {
    file { 'mongodb.dir':
      ...
      recurse => true,
      purge   => $mongodb::source_dir_purge,
      replace => $mongodb::manage_file_replace,
      audit   => $mongodb::manage_audit,
    }
  }
